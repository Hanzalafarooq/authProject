                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="single-product">
                                <div class="product-img">
                                    <a href="{{ route('product.details', ['id' => $prices->id]) }}">


                                        <img class="default-img" src="{{ asset('products/img/' . $prices->image) }}"
                                            alt="#">

                                        <img class="hover-img" src="{{ asset('products/img/' . $prices->image) }}"
                                            alt="#">
                                    </a>
                                    <div class="button-head">
                                        ...
                                        <div class="product-action-2">
                                            <form action="{{ route('cart.store') }}" method="POST"
                                                ...
                                                <input type="hidden" value="{{ $prices->discounted_price }}"
                                                    name="price">
                                                {{-- <input type="hidden" value="{{ $prices->Description }}"
                                                name="desc"> --}}
                                                <input type="hidden" value="{{ $prices->image }}" name="image">
                                                <input type="hidden" value="1" name="quantity">
                                                <button class="px-4 py-2 text-white bg-dark rounded">Add To
                                                    Cart</button>
                                            </form>
                                        </div>
                                    </div>
                                ...
                                <div class="product-content">
                                    ...
                                    <h3><a
                                            href="{{ url('/detail', ['id' => $prices->id]) }}">{{ $prices->title }}</a>
                                    </h3>
