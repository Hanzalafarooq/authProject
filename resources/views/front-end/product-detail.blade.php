...
<div class="pd-wrap">
    <div class="container">
            ...
            <div class="col-md-6">
                <div id="slider" class="owl-carousel product-slider">
                    <div class="item">
                        ...
                        <img src="{{ asset('products/img/' . $product->image) }}" style="height: 20pc" />
                ...
                <div id="thumb" class="owl-carousel product-thumb">
                    @foreach ($gallery as $photo)
                        <div class="item">
                            <img src="{{ asset('products/gallery/' . $photo->gallery) }}" />
                        </div>
                    @endforeach
                </div>
            </div>
            <div class="col-md-6">
                <div class="product-dtl">
                    <div class="product-info">
                        ...
                        <div class="product-price-discount"><input type="hidden" name="dprice"
                                value="{{ $product->price }}" />
            ...
            <label for="size">Quantity</label>
              ...
              <div class="qtyplus">+</div> --}}
                    ...
                    <form action="{{ route('cart.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="hidden" value="{{ $product->discounted_price }}" name="price">
        ...
        <div style="text-align:center;font-size:14px;padding-bottom:20px;">Get free icon packs for your next project at
