<x-front-component.main />
<x-front-component.header-sep />
<!-- Breadcrumbs -->
...
<section class="shop checkout section">
        ...
        <div class="row">
            <div class="col-lg-8 col-12">
                <div class="checkout-form">
                    ...
                    <!-- Form -->
                    <form class="form" method="post" action="{{ route('storedata') }}">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <select name="city" id="state-province">
                                        <option value="Islamabad" selected="selected">Pindi</option>
                            ...
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="grandtotal"
                                        value="{{ Cart::getTotal() - session('discount') }}" required>
                                    <input type="hidden" name="subtotal" value="{{ Cart::getTotal() }}" required>
                                    <input type="hidden" name="discount" value="{{ session('discount') }}" required>
                                </div>
                            </div>
                            {{-- <div class="col-lg-6 col-md-6 col-12">
                                <div class="form-group">
                ...
                <div class="order-details">
                    ...
                    <div class="single-widget">
                        ...
                        <div class="content">
                            <ul>
                                <li>Sub
                                    Total<span>${{ Cart::getContent()->sum(function ($item) {
                                                    return ($item->price - $item->discount) * $item->quantity;
                                                }) - session('discount') }}</span>
                                </li>
                                <li>(+) Shipping<span>$10.00</span></li>
                                <li class="last">Total<span>${{ number_format(Cart::getTotal() - session('discount')) }}</span></li>
                            </ul>
                        </div>
                    </div>
                    <!--/ End Order Widget -->
    ...
    <p>Item ID: {{ $itemId }}</p>
    <p>Quantity: {{ $quantities[$key] }}</p>
    <p>Price: {{ $prices[$key] }}</p>
@endforeach --}}
                            ...
                            <div class="button">
                                ...
                                <form action="{{ route('storedata') }}" method="POST">
                                    ...
                                    @foreach ($itemIds as $key => $itemId)
                                        ...
                                        <input type="hidden" name="prices[]" value="{{ $prices[$key] }}">
                                    @endforeach
                                    <input type="hidden" name="subtotals"
                                        value="{{ number_format(Cart::getTotal() - session('discount')) }}">
{{-- <p>Total Price: ${{ number_format(Cart::getTotal() - session('discount')) }}</p> --}}
...
<!--/ End Checkout -->
<x-front-component.newsletter-inner />
<x-front-component.footer />
